  ...
  ui <- dashboardPage(
    ...
    dashboardSidebar(
      sidebarMenu(
        ...
        #You can change max to 18000 but  the geomaps will cause it to take a lot longer to load
        sliderInput("slider", "Number of observations:", 50, 500, 50),
    ...
    dashboardBody(
      navbarPage("Navigation Bar", id="myNavbar",
                 tabPanel("Instructions",
                          ...
                          twitter for. The first slide bar ranges from 50 to 500 and will be the number of tweets 
...
#Server_____________________________________________________
{
  ...
  #Create Wordcloud
    output$wordCloud <- renderPlot({
      ...
      stop_words<-data$sw
      ################################  
      #Most likely outputs in wordcloud to remove
  ...
  ################################    
  #Make map of where each Tweet came from  
